...
public class AudioStateOutputStream extends PipedOutputStream {
    ...
    protected AudioStateOutputStream(PipedInputStream inputStream, RecordingStateListener stateListener, final RecordingRMSListener rmsListener) throws IOException {
        super(inputStream);
    ...
    public void write(byte[] b, int off, int len) throws IOException {
        ...
        try {
            ...
            Log.d("Failed to flush", e.getMessage(), e);
            throw e;
        }
        calculateDB(b, len);
    }
