...
import org.freelectron.leobel.testlwa.models.message.response.ProgressReport;
...
public class AudioPlayerProgressReporter {
    ...
    private void scheduleDelayEvent(long delay) {
        Log.d("Scheduling", "Scheduling ProgressReportDelayElapsed event in {} " + String.valueOf(delay) + "ms");
    ...
    private void scheduleIntervalEvent(long delay, long interval) {
        Log.d("Scheduling", "Scheduling ProgressReportIntervalElapsed event in " + String.valueOf(delay) +  " ms that will repeat every " + String.valueOf(interval) + " ms");
