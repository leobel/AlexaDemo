...
public class MainActivity extends AppCompatActivity implements LoginResultListener {
    ...
    private static final String PRODUCT_ID = "testalexa";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login = (ImageView) findViewById(R.id.login_with_amazon);
    ...
    protected void onStart(){
        super.onStart();
        if(preferenceService.getAccessToken().isEmpty()){
            authorizeListener.checkAccessToken();
        }
        else{
            startActivity(new Intent(this, AlexaSpeechRecognizerActivity.class));
        }
    }
    ...
    public class AuthorizeListenerImpl extends AuthorizeListener {
        ...
        public void checkAccessToken(){
            AuthorizationManager.getToken(MainActivity.this, new Scope[] { ScopeFactory.scopeNamed(ALEXA_ALL_SCOPE) }, new TokenListener(this));
